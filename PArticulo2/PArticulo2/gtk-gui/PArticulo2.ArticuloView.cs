...
namespace PArticulo2
{
	public partial class ArticuloView
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget PArticulo2.ArticuloView
			...
			this.Name = "PArticulo2.ArticuloView";
			this.Title = global::Mono.Unix.Catalog.GetString ("ArticuloView");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Container child PArticulo2.ArticuloView.Gtk.Container+ContainerChild
			...
			this.hbox3.Add (this.spinButtonPrecio);
			global::Gtk.Box.BoxChild w5 = ((global::Gtk.Box.BoxChild)(this.hbox3 [this.spinButtonPrecio]));
			w5.Position = 0;
			w5.Expand = false;
			w5.Fill = false;
